...
import { Clock, MapPin, CheckCircle, AlertCircle, Calendar, User, Map, Users } from 'lucide-react';
...
const PointagePage: React.FC = () => {
  ...
  return (
    // MODIFICATION: Suppression du container-fluid, ajout de position fixed et dimensions 100%
    <div className="top-0 overflow-auto position-fixed start-0 w-100 h-100" style={{ background: '#f0f2f5', padding: '2rem' }}>
      <style>
        {`
